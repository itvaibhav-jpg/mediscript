 ...
 * This script reads index.html, applies the fix, and saves it back
 * 
 * Usage: node apply-patients-fix.js
 */

const fs = require('fs');
const path = require('path');

const INDEX_PATH = path.join(__dirname, 'demo', 'ai', 'index.html');

console.log('🔧 Starting Patients Tab Fix...\n');

// Read the file
let content = fs.readFileSync(INDEX_PATH, 'utf8');

// PATIENTS TAB HTML TO INSERT
const PATIENTS_TAB_HTML = `
        <!-- Patients Tab -->
...
console.log('✅ Step 1: Inserting Patients Tab HTML...');

// Insert Patients Tab HTML before AI Clinical tab
content = content.replace(
    '        <!-- AI Clinical Decision Support Tab -->',
    PATIENTS_TAB_HTML + '\n        <!-- AI Clinical Decision Support Tab -->'
);

console.log('✅ Step 2: Replacing showAddPatient() function...');

// Replace showAddPatient function
const oldFunction = `        function showAddPatient() {
            alert('Patient management feature - Add patient form will appear here');
        }`;

const newFunctions = `        // Patient Management Functions
...
console.log('✅ Step 3: Adding initialization...');

// Add initialization before closing script tag
content = content.replace(
    '        // Load dark mode preference',
    `        // Initialize patients display on page load
...
console.log('\n🎉 SUCCESS! Patients Tab fix applied successfully!');
console.log('\n📝 Changes made:');
console.log('  ✅ Inserted Patients Tab HTML');
console.log('  ✅ Replaced showAddPatient() with full patient management');
console.log('  ✅ Added displayPatients() initialization');
console.log('\n🧪 Test the fix by opening demo/ai/index.html in your browser');
console.log('   Click the "Patients" tab and try adding a patient!');
